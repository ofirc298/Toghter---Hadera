      ...
      className="
        ...
        <div 
          ...
          <p 
            ...
            {"שלום לכולם,"}
            <br/>
            {"שלום לכולם, שמי נורית מנחם ויחד עם קבוצה נוספת של אנשים טובים החלטנו לקשר בין משפחות מאזור חדרה והסביבה המעוניינות לארח לארוחת שישי, שבת או סתם לערב בכייף באמצע השבוע, משפחות שפונו מבתיהם ומתארחות בחדרה במלון גייקוב ובכפר הנופש לחיילים בגבעת אולגה."}
          </p>
          <p 
            className='
              ...
              sm:px-[15vw] 
              md:px-0 md:text-right '>
            {"הכוונה היא ליצור רגע של משפחתיות וחום ויציאה מהטירוף במציאות בלתי נתפסת לכולנו. כולנו רוצים לתת וכולנו יודעים שרק ביחד ננצח בכוח וברוח והנה הזדמנות מצוינת פשוט לתת באופן הדדי."}
          </p>
        </div>
