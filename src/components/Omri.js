...
import '../styles/omri/omri.css'

function Omri() {
    return (
        <div className='flex justify-center items-center'>
            <a href='https://www.facebook.com/omri.niv.fireshtein.memorial' Style={'margin-left: 2%;'} >
                <svg xmlns="http://www.w3.org/2000/svg" className='facebook' width="45" height="45" fill="#0B4D9D" class="bi bi-facebook" viewBox="0 0 16 16">
